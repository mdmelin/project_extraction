...
from project_extraction.projects.krasniak_widefield import WidefieldSyncKrasniak
...
class TestWidefieldSync(base.IntegrationTest):
    ...
    def setUp(self):
        ...
        self.patch = unittest.mock.patch('project_extraction.projects.krasniak_widefield.get_video_meta',
